...
function FeaturedProductsGrid({ go }) {
  ...
  if (loading) return (
    <div className="glass-blur" style={{padding: '2rem', textAlign: 'center'}}>
      <div style={{fontSize: '1.2rem', marginBottom: '0.5rem'}}>🔄 Loading Featured Products...</div>
  ...
  if (error) return (
    <div className="glass-blur" style={{padding: '2rem', textAlign: 'center'}}>
      <div style={{fontSize: '1.2rem', marginBottom: '0.5rem', color: 'var(--danger)'}}>⚠️ Error Loading Products</div>
  ...
  if (!items.length) return (
    <div className="glass-blur" style={{padding: '2rem', textAlign: 'center'}}>
      <div style={{fontSize: '1.2rem', marginBottom: '0.5rem'}}>📦 No Products Available</div>
